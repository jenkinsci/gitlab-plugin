...
class OpenMergeRequestTagPushHookTriggerHandler implements TagPushHookTriggerHandler {

    private static final Logger LOGGER = Logger.getLogger(OpenMergeRequestTagPushHookTriggerHandler.class.getName());
    ...
    private CauseData retrieveCauseData(TagPushEvent event, Project project, MergeRequest mergeRequest, Branch branch) {
        return causeData()
    ...
    private URIish retrieveUrIish(TagPushEvent event) {
        try {
