...
class OpenMergeRequestTagPushSystemHookTriggerHandler implements TagPushSystemHookTriggerHandler {
    ...
    private CauseData retrieveCauseData(
            TagPushSystemHookEvent event, Project project, MergeRequest mergeRequest, Branch branch) {
        return causeData()
    ...
    private URIish retrieveUrIish(TagPushSystemHookEvent event) {
        try {
