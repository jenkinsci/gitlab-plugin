...
class OpenMergeRequestPushHookTriggerHandler implements PushHookTriggerHandler {
    ...
    private void handleMergeRequest(Job<?, ?> job, PushHook hook, boolean ciSkip, Filter branchFilter, GitLabApi client, MergeRequest mergeRequest) {
        ...
        if (targetBranch != null && branchFilter.accept(targetBranch) && hook.getRef().equals("refs/heads/"+targetBranch) && sourceBranch != null) {
