...
1. In the *Source Code Management* section:
    ...
    3. In *Branch Specifier* enter: ``origin/${gitlabSourceBranch}``
        * To handle merge requests add a second *Branch Specifier*: ``origin/merge-requests/${gitlabMergeRequestIid}``
