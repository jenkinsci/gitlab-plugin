...
##Introduction
This plugin allows you to create a new project based on the repository structure based on your GitLab
...
This plugin scans your GitLab server for projects according to criteria you can specify. 
...
When the proper webhooks are configured, this plugin automatically detects new projects, branches and
